...
scoreboard players operation @e[type=item,nbt={Item:{id:"minecraft:coal"}},distance=..1] mech.power *= coal mech.power
...
scoreboard players operation @e[type=item,nbt={Item:{id:"minecraft:charcoal"}},distance=..1] mech.power *= coal mech.power
